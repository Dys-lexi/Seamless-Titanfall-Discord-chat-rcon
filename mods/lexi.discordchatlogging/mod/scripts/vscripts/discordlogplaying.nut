...
discordlogcommand function discordlogplayingpoll( discordlogcommand commandin )
{
	...
	foreach ( entity player in players )
	{
		...
		if ( player != null )
		{
			...
			playerlist[ playerinfoe.uid ] <-
				[ playerinfoe.score, playerinfoe.team, playerinfoe.kills, playerinfoe.deaths, playerinfoe.playername, playerinfoe.titankills, playerinfoe.npckills, playerinfoe.timeconnected, playerinfoe.ip ]
		}
	}
	int mtimeleft = 0
	try
